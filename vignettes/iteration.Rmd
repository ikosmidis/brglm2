...
author: "[Ioannis Kosmidis](http://www.ucl.ac.uk/~ucakiko/), [Eugene Clovis Kenne Pagui](http://homes.stat.unipd.it/eulogecloviskennepagui/en/content/home) and [Nicola Sartori](https://homes.stat.unipd.it/nicolasartori/)"
date: "29 April 2017"
...
\end{align*}
then the solution of the adjusted score equations $s_\beta + A_\beta = 0_p$ and $s_\phi + A_\phi = 0$ results in estimators $\tilde\beta$ and $\tilde\phi$ with median bias of smaller asymptotic order than the maximum likelihood estimator. In the above expressions,
\begin{align*}
...
The vignette has been written and by Ioannis Kosmidis. Eugene Clovis Kenne Pagui and Nicola Sartori have contributed the first version of the section "Median bias-reducing adjusted score functions".
