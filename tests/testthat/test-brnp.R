...
test_that("brnp returns the same estimates as MASS::glm.nb", {
    expect_equal(coef(fitML), coef(fitML_glmnb), tol = 1e-06)
})

test_that("brnp returns mean BR and median BR estimates as in Kenne Pagui et al (2021+)", {
...
test_that("prior weights work as expected", {
