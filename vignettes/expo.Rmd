---
title: "Estimating exponentials of regression parameters using **brglm2**"
author: "[Ioannis Kosmidis](https://www.ikosmidis.com)"
date: "03 February 2023"
output: rmarkdown::html_vignette
bibliography: brglm2.bib
vignette: >
  %\VignetteIndexEntry{Estimating exponentials of regression parameters using **brglm2**}
...
The data analysed in @agresti:02[, Section 5.4.2] is from a 3-year
