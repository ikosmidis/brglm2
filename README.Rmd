...
controlling for `PI` and `EH`. Note here that, the maximum likelihood estimate of the odds ratio is not as useful as the the `correction*` estimates, because it is $+\infty$ with an infinite standard error (see previous section). 
