...
The following chunk of code fits an adjacent category logit model with proportional odds and reproduces @agresti:10[, Table 4.2]. Note that the intercept parameters are different because @agressti:10[, Table 4.2] uses different contrasts for the intercept parameters.
```{r, echo = TRUE}
...
# Prediction
We can predict the category probabilities using the `predict` method on
