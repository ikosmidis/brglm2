...
about 8.5 times higher when neovasculation is present. An approximate
95% interval for the latter odds ratio is 1.4, 51.7 providing evidence
of association between `NV` and `HG` while controlling for `PI` and
`EH`.
