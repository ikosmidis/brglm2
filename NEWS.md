...
* Deprecated `detect_sepration` and `check_infinite_estimates`, which
  will be removed from **brglm2** at version 0.7. Improved and more
  extensible versions of `detect_sepration` and
  `check_infinite_estimates` are now provided by the
